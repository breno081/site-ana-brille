...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (hamburger && menuToggle) {
    console.log('Hamburger e menu-toggle encontrados no DOM.');
    hamburger.addEventListener('click', () => {
      console.log('Hamburger clicado, estado atual do checkbox:', menuToggle.checked);
      menuToggle.checked = !menuToggle.checked;
      console.log('Novo estado do checkbox:', menuToggle.checked);
    });
  } else {
    console.error('Erro: Elemento .hamburger ou #menu-toggle não encontrado no DOM.');
  }
